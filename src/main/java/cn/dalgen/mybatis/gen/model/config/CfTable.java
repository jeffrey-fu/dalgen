...
public class CfTable {
    ...
    private Map<String, String> sqlContextMap = Maps.newHashMap();
    ...
    public Map<String, String> getSqlContextMap() {
        return sqlContextMap;
    }

    public void addSqlContextMap(String id, String sqlText) {
        this.sqlContextMap.put(id,sqlText);
    }
}
