...
<#function resultSetType operation>
    <#if operation.resultSetType?? && operation.resultSetType != "DEFAULT">
        <#return ' resultSetType="${operation.resultSetType}"'>
    </#if>
    <#return ""/>
</#function>

<#function fetchSize operation>
    <#if operation.resultSetType?? && operation.resultSetType != "DEFAULT" && operation.fetchSize??>
        <#return ' fetchSize="${operation.fetchSize}"'>
    </#if>
    <#return ""/>
</#function>
